...
def test_bulenox_futures():
    ...
    try:
        ...
        try:
            ...
            timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
            screenshot_path = (
                f"{screenshot_dir}/bulenox_interface_not_found_{timestamp}.png"
            )
            driver.save_screenshot(screenshot_path)
            print(f"Screenshot saved to: {screenshot_path}")
        ...
        try:
            ...
            if not symbol_input:
                ...
                timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
                screenshot_path = (
                    f"{screenshot_dir}/bulenox_no_symbol_input_{timestamp}.png"
                )
                driver.save_screenshot(screenshot_path)
                print(f"Screenshot saved to: {screenshot_path}")
            ...
            # Use the Micro Bitcoin futures symbol visible in the screenshot
            futures_symbol = "MBTQ25"  # Micro Bitcoin futures contract
            ...
            timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
            screenshot_path = (
                f"{screenshot_dir}/bulenox_symbol_search_error_{timestamp}.png"
            )
            driver.save_screenshot(screenshot_path)
            print(f"Screenshot saved to: {screenshot_path}")
            raise
        ...
        try:
            ...
            WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable(
                    (By.XPATH, "//div[contains(text(), 'MBTQ25')]")
                )
            ).click()
        ...
        try:
            ...
            if quantity_input:
                ...
                timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
                screenshot_path = (
                    f"{screenshot_dir}/bulenox_no_quantity_input_{timestamp}.png"
                )
                driver.save_screenshot(screenshot_path)
                print(f"Screenshot saved to: {screenshot_path}")
        except Exception as e:
        ...
        try:
            ...
            sl_input.clear()
            sl_input.send_keys("117000")
            print("Set stop loss to 117000")
        except Exception as e:
        ...
        try:
            ...
            tp_input.clear()
            tp_input.send_keys("119000")
            print("Set take profit to 119000")
        except Exception as e:
...
if __name__ == "__main__":
    print("AI Trading Sentinel - Bulenox Futures Trading Test")
    print("=================================================")
