#!/usr/bin/env python3
"""
TradeBot Sentinel - Advanced Professional Trading Automation
============================================================

A comprehensive trading automation system with:
- Secure login via environment variables
- Network request interception and cURL capture
- Trade execution detection and automation
- Robust error handling and retry mechanisms
- Monitor and headless modes for different operational phases
- Auto-restart capabilities and process monitoring

Usage:
    python tradebot_sentinel_advanced_pro.py --monitor    # Monitor mode for stability testing
    python tradebot_sentinel_advanced_pro.py --headless   # Headless live trading mode
    python tradebot_sentinel_advanced_pro.py --headed     # Headed mode for debugging
