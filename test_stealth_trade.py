...
def test_stealth_trade():
    ...
    parser.add_argument(
        "-q", "--quantity", type=float, default=0.01, help="Trade quantity"
    )
    parser.add_argument(
        "-sl", "--stoploss", type=float, default=1.0800, help="Stop loss price"
    )
    parser.add_argument(
        "-tp", "--takeprofit", type=float, default=1.1200, help="Take profit price"
    )
