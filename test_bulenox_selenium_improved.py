    ...
    try:
        ...
        if "dashboard" in current_url or "trading" in current_url:
            ...
            trading_screenshot = os.path.join(
                screenshot_dir, "bulenox_trading_page.png"
            )
            ...
            try:
                ...
                pre_login_screenshot = os.path.join(
                    screenshot_dir, "bulenox_pre_login.png"
                )
                ...
                post_login_screenshot = os.path.join(
                    screenshot_dir, "bulenox_post_login.png"
                )
                ...
                error_screenshot = os.path.join(
                    screenshot_dir, "bulenox_login_error.png"
                )
        ...
        if driver:
            error_screenshot = os.path.join(
                screenshot_dir, "bulenox_critical_error.png"
            )
            driver.save_screenshot(error_screenshot)
