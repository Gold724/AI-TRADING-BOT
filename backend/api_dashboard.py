...
default_dashboard_data = {
    ...
    "brokers": {
        "bulenox": {"status": "unknown", "session_count": 0, "last_activity": None},
        "binance": {"status": "unknown", "session_count": 0, "last_activity": None},
        "exness": {"status": "unknown", "session_count": 0, "last_activity": None},
    },
    "strategies": {
...
def update_strategy_info(
    active_strategy=None, available_strategies=None, last_mutation=None
):
...
def update_health_status(
    overall_status=None, recovery_events=None, last_recovery=None, issues=None
):
...
def get_trading_metrics():
    ...
    try:
        data = load_dashboard_data()
        return jsonify({"status": "success", "data": data["trading"]})
    except Exception as e:
...
def get_broker_status():
    ...
    try:
        data = load_dashboard_data()
        return jsonify({"status": "success", "data": data["brokers"]})
    except Exception as e:
...
def get_strategy_info():
    ...
    try:
        data = load_dashboard_data()
        return jsonify({"status": "success", "data": data["strategies"]})
    except Exception as e:
...
def get_signal_metrics():
    ...
    try:
        data = load_dashboard_data()
        return jsonify({"status": "success", "data": data["signals"]})
    except Exception as e:
...
def get_health_status():
    ...
    try:
        data = load_dashboard_data()
        return jsonify({"status": "success", "data": data["health"]})
    except Exception as e:
...
def update_dashboard():
    ...
    try:
        ...
        return jsonify(
            {"status": "success", "message": "Dashboard updated successfully"}
        )
    except Exception as e:
