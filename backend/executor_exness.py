...
class ExecutorExness(BaseExecutor):
    def __init__(self, signal=None, stopLoss=None, takeProfit=None, risk_percent=0.5, max_trades_per_day=6):
        super().__init__(signal, stopLoss, takeProfit)
        self.risk_percent = risk_percent
        self.max_trades_per_day = max_trades_per_day
        self.trades_executed = 0
        self.log_file = "logs/exness_trades.json"
    ...
    def execute_trade(self):
        ...
        if self.trades_executed >= self.max_trades_per_day:
            print("Trade limit reached for Exness. Skipping order.")
            return False
    ...
    def health(self):
        ...
        try:
            ...
            return {"status": "ok", "details": "Exness executor is healthy"}
