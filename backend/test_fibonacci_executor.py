...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test FibonacciExecutor with a sample signal"
    )
    ...
    parser.add_argument(
        "--fib_low", type=float, default=1.0800, help="Fibonacci low price"
    )
    parser.add_argument(
        "--fib_high", type=float, default=1.0900, help="Fibonacci high price"
    )
