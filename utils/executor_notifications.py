...
def notify_login_success(session_id):
    ...
    return send_slack_prophetic(message_type="login_success", session_id=session_id)
...
def notify_login_failure(session_id):
    ...
    return send_slack_prophetic(message_type="login_fail", session_id=session_id)
...
def notify_custom(message, session_id=None):
    ...
    return send_slack_prophetic(message_type=message, session_id=session_id)
