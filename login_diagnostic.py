...
try:
    ...
    try:
        username_selectors = [
            ...
            (
                By.XPATH,
                "//input[@placeholder='Email' or @placeholder='Username' or @placeholder='Email/Username']",
            ),
        ]
        ...
        for by, selector in username_selectors:
            try:
                ...
                print(
                    f"Username field attributes: {username_field.get_attribute('outerHTML')}"
                )
                break
            except:
                continue
        ...
        for by, selector in password_selectors:
            try:
                ...
                print(
                    f"Password field attributes: {password_field.get_attribute('outerHTML')}"
                )
                break
            except:
                continue
        ...
        for by, selector in submit_selectors:
            try:
                ...
                print(
                    f"Submit button attributes: {submit_button.get_attribute('outerHTML')}"
                )
                break
            except:
                continue
