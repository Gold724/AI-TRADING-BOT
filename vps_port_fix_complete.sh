...
curl -s -o /dev/null -w "Broker Credentials: %{http_code}\n" http://localhost:5000/api/broker/credentials 2>/dev/null
...
chmod +x vps_port_fix.sh

echo "🎉 Complete VPS Port Fix Script Created!"
echo "📍 Execute with: sudo bash vps_port_fix.sh"
echo "🔐 Includes Bulenox credentials: BX64883/XujhMzFf6K"
echo "🚀 Ready for live trading deployment!"